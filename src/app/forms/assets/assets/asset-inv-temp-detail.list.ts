...
import { ColumnHeader } from 'app/model/common/column-header';
...
@Component({
    selector: 'asset-inv-temp-detail-list',
    templateUrl: '../../generic/generic.table.list.html'
})
export class AssetInvTempDetailList extends GenericTableList<any, number> {
