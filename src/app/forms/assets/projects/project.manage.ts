...
export class ProjectManage extends GenericManage<Project, number> {
    ...
    constructor(private projectHttpService: ProjectHttpService, private translate: TranslateService) {
        super();
    ...
    private exportToExcel(){
        ...
        this.projectHttpService.get(1, 10000000, 'code', 'asc', params, null).subscribe(
            (data: PagedResult<Project>) => {
