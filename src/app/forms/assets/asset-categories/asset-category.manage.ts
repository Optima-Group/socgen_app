...
@Component({
    selector: 'asset-category-manage',
    templateUrl: 'asset-category.manage.html',
    providers: [ AssetCategoryHttpService ]
})
export class AssetCategoryManage extends GenericManage<AssetCategory, number> {

     @ViewChild('itemDetailModal') modal: ModalDirective;

     private filter: string = '';

    constructor(private assetCategoryHttpService: AssetCategoryHttpService, private translate: TranslateService) {
        super();
